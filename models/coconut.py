# https://github.com/facebookresearch/coconut/blob/main/coconut.py
...
class Coconut(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, labels, position_ids, **kwargs):
        ...
        latent_indices = (input_ids == self.latent_token_id).nonzero()  # (num_latent_tokens_in_the_batch, 2)
    ...
    def generate(
        ...
        **kwargs
        ...
        if synced_gpus:
            ...
            while self.gen_forward_cnt < max_new_tokens + MAX_N_LATENT:  # leave some room for latent tokens
                self.gen_forward_cnt += 1
